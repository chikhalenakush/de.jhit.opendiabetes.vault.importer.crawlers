...
public class JunitAreDetailsCorrect {
	...
	public JunitAreDetailsCorrect(String Device, String SN, Boolean Expected) {
	...
	private Boolean GetDeviceSN(String device2, String sn2) {
		...
		if ((device2.toLowerCase().equals("stick") || device2.toLowerCase().equals("bgdevice")) && sn2.length() == 10) {
